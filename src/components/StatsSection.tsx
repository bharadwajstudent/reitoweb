    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-5xl md:text-6xl font-normal mb-8 leading-tight">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm tracking-widest uppercase">Why Choose Nomad Homes?</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="border-l border-border pl-6 space-y-2"
              >
                <stat.icon className="w-10 h-10 mb-4 text-foreground/60" strokeWidth={1} />
