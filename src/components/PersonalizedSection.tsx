  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 mb-12 sm:mb-16 lg:mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="border border-border bg-background p-6 sm:p-8 space-y-3 sm:space-y-4">
              <h3 className="text-lg sm:text-xl font-normal">Full Support with no Extra Fees</h3>
            ...
            <div className="border border-border bg-background p-6 sm:p-8 space-y-3 sm:space-y-4">
              <h3 className="text-lg sm:text-xl font-normal">Single Point of Contact</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="border border-border bg-background p-6 sm:p-8 space-y-3 sm:space-y-4">
              <h3 className="text-lg sm:text-xl font-normal">Strategic Investment Guidance</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="border border-border bg-background p-6 sm:p-8 space-y-3 sm:space-y-4">
              <h3 className="text-lg sm:text-xl font-normal">Exclusive Investment Opportunities</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
